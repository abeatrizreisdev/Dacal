        ...
        produtos.forEach(produto => {
            ...
            let produtoHTML = `
                <div class='produtoEspecifico'>
                    <a class='linkDoProduto' href='../PHP/detalhesProduto.php?id=${produto.codigoProduto}&from=orcamento'>
            ...
            if (tipoConta === 'admin' || tipoConta === 'funcionario') {
                ...
                produtoHTML += `
                    <a class='botao' id='botaoVisualizar' href='../PHP/detalhesProduto.php?id=${produto.codigoProduto}&from=orcamento'><button>Visualizar</button></a>
                ...
                produtoHTML += `
                    <a class='botao' id='botaoVisualizar' href='../PHP/detalhesProduto.php?id=${produto.codigoProduto}&from=orcamento'><button>Visualizar Detalhes</button></a>`;
