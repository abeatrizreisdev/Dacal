...
function criarProdutoHTMLPasso2(produto) {
    ...
    // Formata o valor unitário para a moeda brasileira
    ...
    // Retorna o HTML do produto com valor formatado e valores de data-atributo para cálculos
    return `
    ...
    fetch('../PHP/exibirOrcamento/exibirOrcamento.php')
        ...
        .then(data => {
            ...
            if (data.message) {
                ...
                const totalFormatado = data.total.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
                const quantidadeTotalFormatada = data.quantidadeTotal.toLocaleString('pt-BR');
